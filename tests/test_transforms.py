...
class TestTransforms(object):
    ...
    def test_pad_to_size(self):
        ...
        assert padded_data.shape == (10, 10)
        assert padded_data[3, 3] == 1
        assert padded_data[2, 2] == 0
    ...
    def test_rotate_shift_image(self):
        ...
        assert transformed_image[7, 5] > 0.9
