"""Handler for the assignExposureGroupPerMicrograph option."""
...
option_name = "assignExposureGroupPerMicrograph"


def add_args(parser: argparse.ArgumentParser) -> None:
    """Add CLI arguments for the assignExposureGroupPerMicrograph option.
...
def handle(
    ...
    """Handle the assignExposureGroupPerMicrograph option.
